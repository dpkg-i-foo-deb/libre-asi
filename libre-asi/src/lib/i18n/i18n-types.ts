...
export type TranslationFunctions = {
	 ...
	 */
	WELCOME_PARAGRAPH_1: () => LocalizedString
	/**
	 * Use the session menu on the upper right corner to log in
	 */
	WELCOME_PARAGRAPH_2: () => LocalizedString
	/**
	 * Visit the
	 */
	WELCOME_VISIT: () => LocalizedString
	/**
	 * GitHub repository
	 */
	WELCOME_GITHUB_REPOSITORY: () => LocalizedString
	/**
	 * to know more and read the documentation
	 */
	WELCOME_KNOW: () => LocalizedString
}
